...
// checkpoint byps.gen.cpp.GenRemoteStub:224
namespace byps { namespace test { namespace api { 
void BSerializer_1775199834(BIO& bio, POBJECT& pObj, PSerializable& pObjS, void* reserved){
	BSerializer_16_Template<byps::test::api::srvr::BStub_ServerIF, 1775199834>(bio, pObj, pObjS, reserved);
}
}}}
...
// checkpoint byps.gen.cpp.PrintContext:496
BTYPEID byps::test::api::ver::BStub_EvolveIF::BSerializable_getTypeId() {
	return 15377840; 
}
namespace byps { namespace test { namespace api { namespace ver { 
...
// checkpoint byps.gen.cpp.GenRemoteStub:224
namespace byps { namespace test { namespace api { 
void BSerializer_15377840(BIO& bio, POBJECT& pObj, PSerializable& pObjS, void* reserved){
	BSerializer_16_Template<byps::test::api::ver::BStub_EvolveIF, 15377840>(bio, pObj, pObjS, reserved);
}
}}}
...
byps::test::api::BRegistry_Testser::BRegistry_Testser()
{
	...
	registerClass(typeid(::byps::BArray1< byps::test::api::cons::PAllTypesZ > ), byps::test::api::BSerializer_85091, 85091);
	...
	registerClass(typeid(byps::test::api::remote::BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars), byps::test::api::BSerializer_361187255, 361187255);
	...
	registerClass(typeid(byps::test::api::remote::BRequest_RemoteProcessingEx_getValueAfterProcessingExceptions), byps::test::api::BSerializer_1155485035, 1155485035);
	...
	registerClass(typeid(byps::test::api::remote::BRequest_RemoteStreams_getSharedStream), byps::test::api::BSerializer_1652400477, 1652400477);
	...
	registerClass(typeid(byps::test::api::remote::BRequest_RemoteStreams_getVideoCheckSupportByteRange), byps::test::api::BSerializer_1006919505, 1006919505);
	registerClass(typeid(byps::test::api::remote::BRequest_RemoteStreams_putSharedStream), byps::test::api::BSerializer_468339492, 468339492);
	...
	registerClass(typeid(byps::test::api::remote::BStub_RemoteProcessingEx), byps::test::api::BSerializer_790485113, 790485113);
