...
namespace byps { namespace test { namespace api { namespace remote { 
byps::PVectorString BStub_RemotePrimitiveTypes::getStringsWithSpecialChars()  {
	BSyncResultT< byps::PVectorString > syncResult;	
	getStringsWithSpecialChars([&syncResult](byps::PVectorString v, BException ex) {
		syncResult.setAsyncResult(v, ex);
	});
	return syncResult.getResult();
}
void BStub_RemotePrimitiveTypes::getStringsWithSpecialChars(::std::function< void (byps::PVectorString, BException ex) > asyncResult)  {
	PMethodRequest req(new BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars());
