...
com::wilutions::byps::test::api::inl::Matrix2D::Matrix2D(float _11, float _12, float _13, float _21, float _22, float _23, float _31, float _32, float _33)
	...
	, _33(_33)
	{}
void com::wilutions::byps::test::api::inl::Matrix2D::serialize(BIO& ar, const unsigned int version) {
	ar & _11;
	ar & _12;
	ar & _13;
	ar & _21;
...
com::wilutions::byps::test::api::inl::Point2D::Point2D(int16_t x, int16_t y)
	...
	, y(y)
	{}
void com::wilutions::byps::test::api::inl::Point2D::serialize(BIO& ar, const unsigned int version) {
	ar & x;
	ar & y;
}
}}}}}}
