...
//-------------------------------------------------
// Implementation of class BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars
// Generated from class byps.gen.cpp.GenApiClass

// checkpoint byps.gen.cpp.GenApiClass:505
BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars::BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars() : BMethodRequest(456456) {
}
// checkpoint byps.gen.cpp.PrintContext:496
BTYPEID byps::test::api::remote::BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars::BSerializable_getTypeId() {
	return 361187255; 
}
// checkpoint byps.gen.cpp.GenApiClass:892
void BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars::serialize(BIO& ar, const BVERSION version) {
}
void byps::test::api::remote::BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars::execute(const PRemote& __byps__remote, PAsyncResult __byps__asyncResult) {
	PRemotePrimitiveTypes __byps__remoteT = byps_ptr_cast<RemotePrimitiveTypes>(__byps__remote);
	__byps__remoteT->getStringsWithSpecialChars([__byps__asyncResult](byps::PVectorString __byps__result, const BException& __byps__ex) {
		if (__byps__ex) {
			__byps__asyncResult->setAsyncResult(BVariant(__byps__ex));
		}
		else {
...
void BSerializer_361187255(BIO& bio, POBJECT& pObj, PSerializable& pObjS, void* pBase) {
	BSerializer_ObjS_Template<byps::test::api::remote::BRequest_RemotePrimitiveTypes_getStringsWithSpecialChars>(bio, pObj, pObjS, pBase);	
}
}}}
namespace byps { namespace test { namespace api { namespace remote { 
