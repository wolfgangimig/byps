...
byps::test::api::BRegistry_Testser::BRegistry_Testser()
{
	...
	registerClass(typeid(byps::test::api::comp::BRequest_IncompatibleChangeIF_changedClass), byps::test::api::BSerializer_1831430414, 1831430414);
	registerClass(typeid(byps::test::api::comp::BRequest_IncompatibleChangeIF_changedParameterType), byps::test::api::BSerializer_214991897, 214991897);
	registerClass(typeid(byps::test::api::comp::BRequest_IncompatibleChangeIF_changedReturnType), byps::test::api::BSerializer_262583988, 262583988);
	registerClass(typeid(byps::test::api::comp::BStub_IncompatibleChangeIF), byps::test::api::BSerializer_88979576, 88979576);
	registerClass(typeid(byps::test::api::comp::IncompatibleChangeInfo), byps::test::api::BSerializer_1107425749, 1107425749);
