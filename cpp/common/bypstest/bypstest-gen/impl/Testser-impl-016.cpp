...
void BSkeleton_ClientIF::putStreams(byps_ptr< ::std::vector< PContentStream > > strm, int32_t ctrl, ::std::function< void (bool, BException ex) > asyncResult)  {
	bool ret = false;
	try {
...
void BSkeleton_ClientIF::sendChat(PChatStructure cs, ::std::function< void (PChatStructure, BException ex) > asyncResult)  {
...
void BStub_ClientIF::putStreams(byps_ptr< ::std::vector< PContentStream > > strm, int32_t ctrl, ::std::function< void (bool, BException ex) > asyncResult)  {
...
void BStub_ClientIF::sendChat(PChatStructure cs, ::std::function< void (PChatStructure, BException ex) > asyncResult)  {
...
void BStub_ServerIF::setPartner(PClientIF client, ::std::function< void (bool, BException ex) > asyncResult)  {
...
void BStub_ServerIF::putStreamsOnClient(byps_ptr< ::std::vector< PContentStream > > streams, ::std::function< void (bool, BException ex) > asyncResult)  {
...
void BStub_EvolveIF::setEvolve(PEvolve obj, ::std::function< void (bool, BException ex) > asyncResult)  {
...
void BStub_EvolveIF::setClient(PEvolveIF partner, ::std::function< void (bool, BException ex) > asyncResult)  {
