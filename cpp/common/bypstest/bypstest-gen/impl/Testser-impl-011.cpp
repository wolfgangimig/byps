...
com::wilutions::byps::test::api::ver::Evolve2::Evolve2(int32_t n1)
	: n1(n1)
	{}
void com::wilutions::byps::test::api::ver::Evolve2::serialize(BIO& ar, const unsigned int version) {
	ar & n1;
}
}}}}}}
...
byps_ptr< BArray1< bool > > BStub_RemoteArrayTypes1dim::getBool()  {
	BSyncResultL<byps_ptr< BArray1< bool > > > syncResult(false);	
...
PBytes BStub_RemoteArrayTypes1dim::getByte()  {
	BSyncResultL<PBytes > syncResult(false);	
...
byps_ptr< BArray1< wchar_t > > BStub_RemoteArrayTypes1dim::getChar()  {
	BSyncResultL<byps_ptr< BArray1< wchar_t > > > syncResult(false);	
...
byps_ptr< BArray1< int16_t > > BStub_RemoteArrayTypes1dim::getShort()  {
	BSyncResultL<byps_ptr< BArray1< int16_t > > > syncResult(false);	
...
byps_ptr< BArray1< int64_t > > BStub_RemoteArrayTypes1dim::getLong()  {
	BSyncResultL<byps_ptr< BArray1< int64_t > > > syncResult(false);	
...
byps_ptr< BArray1< float > > BStub_RemoteArrayTypes1dim::getFloat()  {
	BSyncResultL<byps_ptr< BArray1< float > > > syncResult(false);	
...
byps_ptr< BArray1< double > > BStub_RemoteArrayTypes1dim::getDouble()  {
	BSyncResultL<byps_ptr< BArray1< double > > > syncResult(false);	
