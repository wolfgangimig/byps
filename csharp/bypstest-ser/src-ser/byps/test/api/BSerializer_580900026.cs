...
namespace byps.test.api
{
	...
	public class BSerializer_580900026 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._result, false, byps.test.api.BSerializer_769021986.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._result = (char[,,,])bin.readObj(false, byps.test.api.BSerializer_769021986.instance);
