...
namespace byps.test.api
{
	...
	public class BSerializer_1521577218 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj.resultValue, false, byps.test.api.BSerializer_1201775504.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj.resultValue = (byte[,,,])bin.readObj(false, byps.test.api.BSerializer_1201775504.instance);
