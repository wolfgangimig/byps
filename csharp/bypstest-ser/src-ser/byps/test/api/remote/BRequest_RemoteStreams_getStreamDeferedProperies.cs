...
namespace byps.test.api.remote
{
	...
	public sealed class BRequest_RemoteStreams_getStreamDeferedProperies : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.GetStreamDeferedProperies(BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1205766796L;		
	} // end class
}  // end namespace
