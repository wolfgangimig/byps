...
namespace byps.test.api.remote
{
	...
	public interface RemoteListTypes : BRemote {
		...
		IList<byps.test.api.prim.PrimitiveTypes> GetPrimitiveTypes1();
		void GetPrimitiveTypes1(BAsyncResult<IList<byps.test.api.prim.PrimitiveTypes>> asyncResult) ;
		Task<IList<byps.test.api.prim.PrimitiveTypes>> GetPrimitiveTypes1Async();
		
		void SetPrimitiveTypes1(IList<byps.test.api.prim.PrimitiveTypes> primitiveTypes1);
		void SetPrimitiveTypes1(IList<byps.test.api.prim.PrimitiveTypes> primitiveTypes1, BAsyncResult<Object> asyncResult) ;
		Task SetPrimitiveTypes1Async(IList<byps.test.api.prim.PrimitiveTypes> primitiveTypes1);
		...
		void SetDate1(IList<java.util.Date> obj1);
		void SetDate1(IList<java.util.Date> obj1, BAsyncResult<Object> asyncResult) ;
		Task SetDate1Async(IList<java.util.Date> obj1);
		
		IList<java.util.Date> GetDate1();
		void GetDate1(BAsyncResult<IList<java.util.Date>> asyncResult) ;
		Task<IList<java.util.Date>> GetDate1Async();
