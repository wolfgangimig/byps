...
namespace byps.test.api.remote
{
	...
	public sealed class BRequest_RemoteInlineInstance_setPoint2DList : BMethodRequest, BSerializable
	{
		...
		public override int getRemoteId() { return 355071648; }
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.SetPoint2DList(pointListValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal IList<byps.test.api.inl.Point2D> pointListValue;
