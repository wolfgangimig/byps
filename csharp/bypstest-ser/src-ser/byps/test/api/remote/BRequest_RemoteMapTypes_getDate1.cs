	...
	public sealed class BRequest_RemoteMapTypes_getDate1 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				BAsyncResultSendMethod<IDictionary<String,java.util.Date>> __byps__outerResult = new BAsyncResultSendMethod<IDictionary<String,java.util.Date>>(__byps__asyncResult, new byps.test.api.BResult_1366799209());				
