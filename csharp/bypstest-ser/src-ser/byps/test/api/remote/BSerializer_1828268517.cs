...
namespace byps.test.api.remote
{
	...
	public class BSerializer_1828268517 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._arr2, false, byps.test.api.BSerializer_1957744307.instance);
			bout.writeObj(obj._arr3, false, byps.test.api.BSerializer_196606293.instance);
			bout.writeObj(obj._arr4, false, byps.test.api.BSerializer_39910537.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._arr2 = (int[,])bin.readObj(false, byps.test.api.BSerializer_1957744307.instance);
			obj._arr3 = (int[,,])bin.readObj(false, byps.test.api.BSerializer_196606293.instance);
			obj._arr4 = (int[,,,])bin.readObj(false, byps.test.api.BSerializer_39910537.instance);
