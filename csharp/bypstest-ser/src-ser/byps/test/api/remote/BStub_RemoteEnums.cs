...
namespace byps.test.api.remote
{
	...
	public class BStub_RemoteEnums : BStub, RemoteEnums, BSerializable {	
		...
		public byps.test.api.enu.EnumPlanets GetPlanet() {
		...
		public void GetPlanet(BAsyncResult<byps.test.api.enu.EnumPlanets> asyncResult) {
		...
		public void SetPlanet(byps.test.api.enu.EnumPlanets planet) {
