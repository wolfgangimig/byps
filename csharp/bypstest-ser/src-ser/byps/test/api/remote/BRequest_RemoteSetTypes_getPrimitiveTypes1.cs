	...
	public sealed class BRequest_RemoteSetTypes_getPrimitiveTypes1 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				BAsyncResultSendMethod<ISet<byps.test.api.prim.PrimitiveTypes>> __byps__outerResult = new BAsyncResultSendMethod<ISet<byps.test.api.prim.PrimitiveTypes>>(__byps__asyncResult, new byps.test.api.BResult_673917574());				
		...
		public static readonly long serialVersionUID = 669274715L;		
	} // end class
}  // end namespace
