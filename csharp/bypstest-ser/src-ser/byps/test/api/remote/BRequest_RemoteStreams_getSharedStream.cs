...
namespace byps.test.api.remote
{
	...
	public sealed class BRequest_RemoteStreams_getSharedStream : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.GetSharedStream(idValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1652400477L;		
	} // end class
}  // end namespace
