...
namespace byps.test.api.remote
{
	...
	public class BSerializer_759940243 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._primitiveTypes1, false, byps.test.api.BSerializer_1596367810.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._primitiveTypes1 = (IList<byps.test.api.prim.PrimitiveTypes>)bin.readObj(false, null);
