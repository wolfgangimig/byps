...
namespace byps.test.api.remote
{
	...
	public class BSerializer_2098036489 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_2098036489();
		
		public BSerializer_2098036489()
			: base(2098036489) {}
		
		public BSerializer_2098036489(int typeId)
			: base(typeId) {}
