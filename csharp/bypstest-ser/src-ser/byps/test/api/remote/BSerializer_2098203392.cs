...
namespace byps.test.api.remote
{
	...
	public class BSerializer_2098203392 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_2098203392();
		
		public BSerializer_2098203392()
			: base(2098203392) {}
		
		public BSerializer_2098203392(int typeId)
			: base(typeId) {}
