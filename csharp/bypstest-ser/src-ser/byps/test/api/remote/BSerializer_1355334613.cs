...
namespace byps.test.api.remote
{
	...
	public class BSerializer_1355334613 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._pointArray, false, byps.test.api.BSerializer_184101377.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._pointArray = (byps.test.api.inl.Point2D[])bin.readObj(false, byps.test.api.BSerializer_184101377.instance);
