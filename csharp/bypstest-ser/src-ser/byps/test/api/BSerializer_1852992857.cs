...
namespace byps.test.api
{
	...
	public class BSerializer_1852992857 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._result, false, byps.test.api.BSerializer_945713488.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._result = (bool[,,,])bin.readObj(false, byps.test.api.BSerializer_945713488.instance);
