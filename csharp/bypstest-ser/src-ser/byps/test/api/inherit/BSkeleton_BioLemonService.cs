...
namespace byps.test.api.inherit
{
	...
	public class BSkeleton_BioLemonService : BSkeleton, BioLemonService {	
		...
		public virtual async void Pick(byps.test.api.auth.SessionInfo sess, String fromTree, BAsyncResult<String> asyncResult) {
			String ret = default(String);
			Exception ex = null;
			bool callAsync = false;
			try {
		...
		public virtual Task<String> PickAsync(byps.test.api.auth.SessionInfo sess, String fromTree){
			return BTaskConstants<String>.NotImplemented;
		}
