...
namespace byps.test.api
{
	...
	public class BSerializer_1073221568 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj.resultValue, false, byps.test.api.BSerializer_1596367810.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj.resultValue = (IList<byps.test.api.prim.PrimitiveTypes>)bin.readObj(false, null);
