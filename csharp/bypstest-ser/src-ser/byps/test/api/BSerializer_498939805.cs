...
namespace byps.test.api
{
	...
	public class BSerializer_498939805 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj.resultValue, false, byps.test.api.BSerializer_100361105.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj.resultValue = (int[])bin.readObj(false, byps.test.api.BSerializer_100361105.instance);
