...
namespace byps.test.api
{
	...
	public class BSerializer_1693860029 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._result, false, byps.test.api.BSerializer_1358523233.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._result = (IDictionary<int,byps.test.api.inl.Point2D>)bin.readObj(false, null);
