...
namespace byps.test.api
{
	...
	public class BSerializer_996163680 : BSerializer {
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._result, false, byps.test.api.BSerializer_124584219.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._result = (Object[,,,])bin.readObj(false, byps.test.api.BSerializer_124584219.instance);
