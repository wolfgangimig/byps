	...
	public sealed class BRequest_RemoteListTypes_getChar1 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				BAsyncResultSendMethod<IList<char>> __byps__outerResult = new BAsyncResultSendMethod<IList<char>>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_1661807911());				
		...
		public static readonly long serialVersionUID = 1319940748L;		
	} // end class
}  // end namespace
