	...
	public sealed class BRequest_RemoteSetTypes_getInt2 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				BAsyncResultSendMethod<ISet<int[]>> __byps__outerResult = new BAsyncResultSendMethod<ISet<int[]>>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_1406124761());				
		...
		public static readonly long serialVersionUID = 68372556L;		
	} // end class
}  // end namespace
