...
namespace com.wilutions.byps.test.api.inherit
{
	...
	public sealed class BRequest_PlantService_grow : BMethodRequest, BSerializable
	{
		...
		public override int getRemoteId() { return 1117460801; }
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				__byps__remoteT.GrowAsync(__byps__outerResult);
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1534230652L;		
	} // end class
}  // end namespace
