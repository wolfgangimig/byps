...
namespace com.wilutions.byps.test.api.remote
{
	...
	public class BSerializer_1083385729 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1083385729();
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._v, false, com.wilutions.byps.test.api.BSerializer_766441794.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._v = (float[])bin.readObj(false, com.wilutions.byps.test.api.BSerializer_766441794.instance);
