...
namespace com.wilutions.byps.test.api.remote
{
	...
	public class BSerializer_1047136253 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1047136253();
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._obj1, false, com.wilutions.byps.test.api.BSerializer_1488550492.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._obj1 = (IDictionary<String,Object>)bin.readObj(false, null);
