	...
	public sealed class BRequest_RemoteReferences_setNode : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				__byps__remoteT.async_SetNode(_v, __byps__outerResult);
			} catch (Exception e) {
		...
		internal com.wilutions.byps.test.api.refs.Node _v;

		#endregion
		
		
		public static readonly long serialVersionUID = 1404172848L;		
	} // end class
}  // end namespace
