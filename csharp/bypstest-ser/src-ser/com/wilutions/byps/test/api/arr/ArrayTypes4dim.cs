...
namespace com.wilutions.byps.test.api.arr
{
	...
	public class ArrayTypes4dim : BSerializable
	{
		...
		internal ArrayTypes4dim(bool[,,,] @boolean4, byte[,,,] @byte4, char[,,,] @char4, short[,,,] @short4, int[,,,] @int4, long[,,,] @long4, float[,,,] @float4, double[,,,] @double4, String[,,,] @string4, com.wilutions.byps.test.api.prim.PrimitiveTypes[,,,] @primitiveTypes4) {
		...
		protected com.wilutions.byps.test.api.prim.PrimitiveTypes[,,,] _primitiveTypes4;
