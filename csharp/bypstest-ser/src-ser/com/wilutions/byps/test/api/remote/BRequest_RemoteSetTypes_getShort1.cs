	...
	public sealed class BRequest_RemoteSetTypes_getShort1 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				BAsyncResultSendMethod<ISet<short>> __byps__outerResult = new BAsyncResultSendMethod<ISet<short>>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_2028443792());				
		...
		public static readonly long serialVersionUID = 1000850298L;		
	} // end class
}  // end namespace
