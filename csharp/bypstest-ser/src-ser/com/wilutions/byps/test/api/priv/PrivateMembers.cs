...
namespace com.wilutions.byps.test.api.priv
{
	...
	public class PrivateMembers : BSerializable
	{
		...
		internal PrivateMembers(bool @boolVal, byte @byteVal, char @charVal, short @shortVal, int @intVal, long @longVal, float @floatVal, double @doubleVal, String @stringVal, com.wilutions.byps.test.api.prim.PrimitiveTypes @primitiveTypes, bool[] @arrBool, int[] @arrInt, String[] @arrString, com.wilutions.byps.test.api.prim.PrimitiveTypes[] @arrPrimitiveTypes, IList<bool> @listBool, IList<int> @listInt, IList<String> @listString, IList<com.wilutions.byps.test.api.prim.PrimitiveTypes> @listPrimitiveTypes, IDictionary<int,IList<String>> @mapIntListString, int @protInt, int @pprotInt) {
		...
		public com.wilutions.byps.test.api.prim.PrimitiveTypes PrimitiveTypes
		{
			get
			{
		...
		public com.wilutions.byps.test.api.prim.PrimitiveTypes[] ArrPrimitiveTypes
		{
			get
			{
		...
		public IList<com.wilutions.byps.test.api.prim.PrimitiveTypes> ListPrimitiveTypes
		{
			get
			{
		...
		protected com.wilutions.byps.test.api.prim.PrimitiveTypes _primitiveTypes;
		...
		protected com.wilutions.byps.test.api.prim.PrimitiveTypes[] _arrPrimitiveTypes;
		...
		protected IList<com.wilutions.byps.test.api.prim.PrimitiveTypes> _listPrimitiveTypes;
