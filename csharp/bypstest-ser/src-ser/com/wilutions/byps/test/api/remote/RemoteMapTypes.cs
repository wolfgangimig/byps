...
namespace com.wilutions.byps.test.api.remote
{
	...
	public interface RemoteMapTypes : BRemote {
		...
		void GetPrimitiveTypes1(BAsyncResult<IDictionary<int,com.wilutions.byps.test.api.prim.PrimitiveTypes>> asyncResult) ;
		Task<IDictionary<int,com.wilutions.byps.test.api.prim.PrimitiveTypes>> GetPrimitiveTypes1Async();
		
		void SetPrimitiveTypes1(IDictionary<int,com.wilutions.byps.test.api.prim.PrimitiveTypes> primitiveTypes1);
		void SetPrimitiveTypes1(IDictionary<int,com.wilutions.byps.test.api.prim.PrimitiveTypes> primitiveTypes1, BAsyncResult<Object> asyncResult) ;
		Task SetPrimitiveTypes1Async(IDictionary<int,com.wilutions.byps.test.api.prim.PrimitiveTypes> primitiveTypes1);
