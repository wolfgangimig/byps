...
namespace com.wilutions.byps.test.api
{
	...
	public class BSerializer_1151524674 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1151524674();
		...
		public override void write(Object obj1, BOutput bout1, long version)
		{
			...
			bout.writeObj(obj._result, false, com.wilutions.byps.test.api.BSerializer_1218831438.instance);
		}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			obj._result = (IList<System.IO.Stream>)bin.readObj(false, null);
