	...
	public sealed class BRequest_RemoteListTypes_getInt2 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				BAsyncResultSendMethod<IList<int[]>> __byps__outerResult = new BAsyncResultSendMethod<IList<int[]>>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_1752158699());				
		...
		public static readonly long serialVersionUID = 874047762L;		
	} // end class
}  // end namespace
