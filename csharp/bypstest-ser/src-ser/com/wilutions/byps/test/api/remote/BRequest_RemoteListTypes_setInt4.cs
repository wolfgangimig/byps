	...
	public sealed class BRequest_RemoteListTypes_setInt4 : BMethodRequest, BSerializable
	{
		...
		public void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				__byps__remoteT.async_SetInt4(_int4, __byps__outerResult);
			} catch (Exception e) {
		...
		internal IList<IDictionary<int,IList<HashSet<int>>>> _int4;

		#endregion
		
		
		public static readonly long serialVersionUID = 1360809952L;		
	} // end class
}  // end namespace
