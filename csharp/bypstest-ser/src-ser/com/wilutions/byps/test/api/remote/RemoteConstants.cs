...
namespace com.wilutions.byps.test.api.remote
{
	...
	public interface RemoteConstants : BRemote
	{
		...
		void async_Compare_HebrewC(com.wilutions.byps.test.api.cons.HebrewZ ALEPH, com.wilutions.byps.test.api.cons.HebrewZ BETH, BAsyncResult<Object> asyncResult) ;
