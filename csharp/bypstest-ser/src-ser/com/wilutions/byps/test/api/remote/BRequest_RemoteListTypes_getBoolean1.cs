	...
	public sealed class BRequest_RemoteListTypes_getBoolean1 : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				BAsyncResultSendMethod<IList<bool>> __byps__outerResult = new BAsyncResultSendMethod<IList<bool>>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_1617670280());				
		...
		public static readonly long serialVersionUID = 1794077576L;		
	} // end class
}  // end namespace
