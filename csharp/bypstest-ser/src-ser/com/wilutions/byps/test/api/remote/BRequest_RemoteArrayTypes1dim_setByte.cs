...
namespace com.wilutions.byps.test.api.remote
{
	...
	public sealed class BRequest_RemoteArrayTypes1dim_setByte : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) {
			try {
				...
				__byps__remoteT.async_SetByte(_v, __byps__outerResult);
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 589243771L;		
	} // end class
}  // end namespace
