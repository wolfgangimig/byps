...
namespace byps.ureq
{
	...
	public sealed class BRequest_BUtilityRequests_execute : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.Execute(functionNameValue, paramsValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 2048473051L;		
	} // end class
}  // end namespace
