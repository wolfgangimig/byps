...
namespace com.wilutions.byps.test.api
{
	...
	public class BSerializer_487702928 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_487702928();
		...
		public override Object read(Object obj1, BInput bin1, int version) {
			...
			// create array
			com.wilutions.byps.test.api.inl.Point2D[,,,] arr =  new com.wilutions.byps.test.api.inl.Point2D[n3,n2,n1,n0];
				...
				for (int i2 = 0; i2 < n2; i2++) {
					for (int i1 = 0; i1 < n1; i1++) {
						for (int i0 = 0; i0 < n0; i0++) {
							arr[i3,i2,i1,i0] = (com.wilutions.byps.test.api.inl.Point2D)bin.readObj(false, com.wilutions.byps.test.api.inl.BSerializer_1835035436.instance);
						}
					}
				}
			}
		...
		public override void write(Object obj1, BOutput bout1, int version) {
			...
			for (int i3 = 0; i3 < n3; i3++) {
				for (int i2 = 0; i2 < n2; i2++) {
					for (int i1 = 0; i1 < n1; i1++) {
						for (int i0 = 0; i0 < n0; i0++) {
							bout.writeObj(arr[i3,i2,i1,i0], false, com.wilutions.byps.test.api.inl.BSerializer_1835035436.instance);
						}
					}
				}
			}
