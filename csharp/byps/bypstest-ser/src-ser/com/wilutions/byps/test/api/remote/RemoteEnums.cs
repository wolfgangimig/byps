...
namespace com.wilutions.byps.test.api.remote
{
	...
	public interface RemoteEnums : BRemote
	{
		...
		void async_GetPlanet(BAsyncResult<com.wilutions.byps.test.api.enu.EnumPlanets> asyncResult) ;
		...
		void async_SetPlanet(com.wilutions.byps.test.api.enu.EnumPlanets planet, BAsyncResult<Object> asyncResult) ;
