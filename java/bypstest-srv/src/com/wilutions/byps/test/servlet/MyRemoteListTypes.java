...
import com.wilutions.byps.test.api.remote.BSkeleton_RemoteListTypes;
...
public class MyRemoteListTypes extends BSkeleton_RemoteListTypes {
	...
	private java.util.List<com.wilutions.byps.test.api.prim.PrimitiveTypes> primitiveTypes1;
	...
	@Override public java.util.List<com.wilutions.byps.test.api.prim.PrimitiveTypes> getPrimitiveTypes1() {
		return primitiveTypes1;
	}
	@Override public void setPrimitiveTypes1(
			java.util.List<com.wilutions.byps.test.api.prim.PrimitiveTypes> primitiveTypes1) {
