...
public class BSerializer_49984088 extends BSerializer_13 {
	...
	public Object read(final Object obj1, final BInput bin1, final long version) throws BException {
		...
		for (int i0 = 0; i0 < n; i0++) {
			...
			java.util.List<java.util.TreeSet<java.lang.Integer>> value = (java.util.List<java.util.TreeSet<java.lang.Integer>>)bin.readObj(false, byps.test.api.BSerializer_724129228.instance);
			map.put(key, value);
		}
		return map;
	}
	...
	public void write(Object obj1, BOutput bout1, final long version)  throws BException {
		...
		for (Map.Entry<java.lang.Integer,java.util.List<java.util.TreeSet<java.lang.Integer>>> obj : map.entrySet()) {
			...
			bout.writeObj(obj.getValue(), false, byps.test.api.BSerializer_724129228.instance);
		}
	}
