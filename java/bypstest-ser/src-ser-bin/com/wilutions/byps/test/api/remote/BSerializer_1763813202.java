...
public class BSerializer_1763813202 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1763813202();
	...
	public BSerializer_1763813202() {
		super(1763813202);
	}
	
	public BSerializer_1763813202(int typeId) {
		super(typeId);
	}
