...
public class BSerializer_1165932789 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1165932789();
	...
	public BSerializer_1165932789() {
		super(1165932789);
	}
	
	public BSerializer_1165932789(int typeId) {
		super(typeId);
	}
