...
public class BSerializer_1165932788 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1165932788();
	...
	public BSerializer_1165932788() {
		super(1165932788);
	}
	
	public BSerializer_1165932788(int typeId) {
		super(typeId);
	}
