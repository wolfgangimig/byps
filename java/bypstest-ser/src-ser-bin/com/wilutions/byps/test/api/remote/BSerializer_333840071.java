...
public class BSerializer_333840071 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_333840071();
	...
	public BSerializer_333840071() {
		super(333840071);
	}
	
	public BSerializer_333840071(int typeId) {
		super(typeId);
	}
