...
public class BSerializer_1795991492 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1795991492();
	...
	public BSerializer_1795991492() {
		super(1795991492);
	}
	
	public BSerializer_1795991492(int typeId) {
		super(typeId);
	}
