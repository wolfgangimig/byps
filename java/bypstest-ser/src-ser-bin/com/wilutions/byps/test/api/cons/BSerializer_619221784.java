...
public class BSerializer_619221784 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_619221784();
	...
	public BSerializer_619221784() {
		super(619221784);
	}
	
	public BSerializer_619221784(int typeId) {
		super(typeId);
	}
