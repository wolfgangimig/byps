...
public class BSerializer_789068826 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_789068826();
	...
	public BSerializer_789068826() {
		super(789068826);
	}
	
	public BSerializer_789068826(int typeId) {
		super(typeId);
	}
