...
public class BSerializer_1790948870 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1790948870();
	...
	public BSerializer_1790948870() {
		super(1790948870);
	}
	
	public BSerializer_1790948870(int typeId) {
		super(typeId);
	}
