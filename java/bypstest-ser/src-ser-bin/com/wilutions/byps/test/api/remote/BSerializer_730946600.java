...
public class BSerializer_730946600 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_730946600();
	...
	public BSerializer_730946600() {
		super(730946600);
	}
	
	public BSerializer_730946600(int typeId) {
		super(typeId);
	}
