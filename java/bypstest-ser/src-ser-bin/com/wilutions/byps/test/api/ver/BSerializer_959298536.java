...
public class BSerializer_959298536 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_959298536();
	...
	public BSerializer_959298536() {
		super(959298536);
	}
	
	public BSerializer_959298536(int typeId) {
		super(typeId);
	}
