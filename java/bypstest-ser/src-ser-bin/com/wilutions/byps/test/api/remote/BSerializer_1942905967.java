...
public class BSerializer_1942905967 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1942905967();
	...
	public BSerializer_1942905967() {
		super(1942905967);
	}
	
	public BSerializer_1942905967(int typeId) {
		super(typeId);
	}
