...
public class BSerializer_879708485 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_879708485();
	...
	public BSerializer_879708485() {
		super(879708485);
	}
	
	public BSerializer_879708485(int typeId) {
		super(typeId);
	}
