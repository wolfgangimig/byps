...
public class BSerializer_57099822 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_57099822();
	...
	public BSerializer_57099822() {
		super(57099822);
	}
	
	public BSerializer_57099822(int typeId) {
		super(typeId);
	}
