...
public class BSerializer_132175071 extends BSerializer_13 {
	...
	public Object read(final Object obj1, final BInput bin1, final int version) throws BException {
		...
		for (int i0 = 0; i0 < n; i0++) {
			...
			java.util.List<java.lang.String> value = (java.util.List<java.lang.String>)bin.readObj(false, com.wilutions.byps.test.api.BSerializer_2123584667.instance);
			map.put(key, value);
		}
		return map;
	}
	...
	public void write(Object obj1, BOutput bout1, int version)  throws BException {
		...
		for (Map.Entry<java.lang.Integer,java.util.List<java.lang.String>> obj : map.entrySet()) {
			...
			bout.writeObj(obj.getValue(), false, com.wilutions.byps.test.api.BSerializer_2123584667.instance);
		}
	}
