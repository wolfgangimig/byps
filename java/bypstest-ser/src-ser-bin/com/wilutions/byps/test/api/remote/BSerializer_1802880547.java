...
public class BSerializer_1802880547 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1802880547();
	...
	public BSerializer_1802880547() {
		super(1802880547);
	}
	
	public BSerializer_1802880547(int typeId) {
		super(typeId);
	}
