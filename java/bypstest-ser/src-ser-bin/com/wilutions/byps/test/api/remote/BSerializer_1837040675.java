...
public class BSerializer_1837040675 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1837040675();
	...
	public BSerializer_1837040675() {
		super(1837040675);
	}
	
	public BSerializer_1837040675(int typeId) {
		super(typeId);
	}
