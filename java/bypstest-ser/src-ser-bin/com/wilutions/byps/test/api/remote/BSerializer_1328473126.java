...
public class BSerializer_1328473126 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1328473126();
	...
	public BSerializer_1328473126() {
		super(1328473126);
	}
	
	public BSerializer_1328473126(int typeId) {
		super(typeId);
	}
