...
public class BSerializer_343973681 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_343973681();
	...
	public BSerializer_343973681() {
		super(343973681);
	}
	
	public BSerializer_343973681(int typeId) {
		super(typeId);
	}
