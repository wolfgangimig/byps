...
public class BSerializer_1271040754 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1271040754();
	...
	public BSerializer_1271040754() {
		super(1271040754);
	}
	
	public BSerializer_1271040754(int typeId) {
		super(typeId);
	}
