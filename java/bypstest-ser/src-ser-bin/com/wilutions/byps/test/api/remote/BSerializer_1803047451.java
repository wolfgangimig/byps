...
public class BSerializer_1803047451 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1803047451();
	...
	public BSerializer_1803047451() {
		super(1803047451);
	}
	
	public BSerializer_1803047451(int typeId) {
		super(typeId);
	}
