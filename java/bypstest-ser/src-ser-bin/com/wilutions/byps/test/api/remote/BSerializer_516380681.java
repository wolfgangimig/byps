...
public class BSerializer_516380681 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_516380681();
	...
	public BSerializer_516380681() {
		super(516380681);
	}
	
	public BSerializer_516380681(int typeId) {
		super(typeId);
	}
