...
public class BSerializer_1540936711 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1540936711();
	...
	public BSerializer_1540936711() {
		super(1540936711);
	}
	
	public BSerializer_1540936711(int typeId) {
		super(typeId);
	}
