...
public class BSerializer_51371910 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_51371910();
	...
	public BSerializer_51371910() {
		super(51371910);
	}
	
	public BSerializer_51371910(int typeId) {
		super(typeId);
	}
