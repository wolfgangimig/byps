...
public class BSerializer_731221838 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_731221838();
	...
	public BSerializer_731221838() {
		super(731221838);
	}
	
	public BSerializer_731221838(int typeId) {
		super(typeId);
	}
