...
public class BSerializer_80010572 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_80010572();
	...
	public BSerializer_80010572() {
		super(80010572);
	}
	
	public BSerializer_80010572(int typeId) {
		super(typeId);
	}
