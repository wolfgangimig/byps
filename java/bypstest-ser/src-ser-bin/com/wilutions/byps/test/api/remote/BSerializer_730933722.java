...
public class BSerializer_730933722 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_730933722();
	...
	public BSerializer_730933722() {
		super(730933722);
	}
	
	public BSerializer_730933722(int typeId) {
		super(typeId);
	}
