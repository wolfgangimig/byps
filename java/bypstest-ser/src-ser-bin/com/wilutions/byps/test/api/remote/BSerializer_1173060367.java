...
public class BSerializer_1173060367 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1173060367();
	...
	public BSerializer_1173060367() {
		super(1173060367);
	}
	
	public BSerializer_1173060367(int typeId) {
		super(typeId);
	}
