...
public class BSerializer_304319631 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_304319631();
	...
	public BSerializer_304319631() {
		super(304319631);
	}
	
	public BSerializer_304319631(int typeId) {
		super(typeId);
	}
