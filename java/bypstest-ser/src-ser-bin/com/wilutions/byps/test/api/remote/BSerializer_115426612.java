...
public class BSerializer_115426612 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_115426612();
	...
	public BSerializer_115426612() {
		super(115426612);
	}
	
	public BSerializer_115426612(int typeId) {
		super(typeId);
	}
