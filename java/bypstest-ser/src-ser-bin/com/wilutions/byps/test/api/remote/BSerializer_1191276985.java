...
public class BSerializer_1191276985 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1191276985();
	...
	public BSerializer_1191276985() {
		super(1191276985);
	}
	
	public BSerializer_1191276985(int typeId) {
		super(typeId);
	}
