...
public class BSerializer_382600378 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_382600378();
	...
	public BSerializer_382600378() {
		super(382600378);
	}
	
	public BSerializer_382600378(int typeId) {
		super(typeId);
	}
