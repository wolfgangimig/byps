...
public class BSerializer_846649496 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_846649496();
	...
	public BSerializer_846649496() {
		super(846649496);
	}
	
	public BSerializer_846649496(int typeId) {
		super(typeId);
	}
