...
public class BSerializer_1382069371 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1382069371();
	...
	public BSerializer_1382069371() {
		super(1382069371);
	}
	
	public BSerializer_1382069371(int typeId) {
		super(typeId);
	}
