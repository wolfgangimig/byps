...
public class BSerializer_1532793931 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1532793931();
	...
	public BSerializer_1532793931() {
		super(1532793931);
	}
	
	public BSerializer_1532793931(int typeId) {
		super(typeId);
	}
