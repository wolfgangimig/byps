...
public class BSerializer_579712360 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_579712360();
	...
	public BSerializer_579712360() {
		super(579712360);
	}
	
	public BSerializer_579712360(int typeId) {
		super(typeId);
	}
