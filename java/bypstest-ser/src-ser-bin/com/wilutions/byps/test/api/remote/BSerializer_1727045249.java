...
public class BSerializer_1727045249 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1727045249();
	...
	public BSerializer_1727045249() {
		super(1727045249);
	}
	
	public BSerializer_1727045249(int typeId) {
		super(typeId);
	}
