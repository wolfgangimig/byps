...
public class BSerializer_2076805380 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_2076805380();
	...
	public BSerializer_2076805380() {
		super(2076805380);
	}
	
	public BSerializer_2076805380(int typeId) {
		super(typeId);
	}
