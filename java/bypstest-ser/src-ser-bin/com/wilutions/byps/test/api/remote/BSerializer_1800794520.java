...
public class BSerializer_1800794520 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1800794520();
	...
	public BSerializer_1800794520() {
		super(1800794520);
	}
	
	public BSerializer_1800794520(int typeId) {
		super(typeId);
	}
