...
public class BSerializer_1480397220 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1480397220();
	...
	public BSerializer_1480397220() {
		super(1480397220);
	}
	
	public BSerializer_1480397220(int typeId) {
		super(typeId);
	}
