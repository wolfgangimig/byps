...
public class BSerializer_431810266 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_431810266();
	...
	public BSerializer_431810266() {
		super(431810266);
	}
	
	public BSerializer_431810266(int typeId) {
		super(typeId);
	}
