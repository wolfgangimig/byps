...
public class BSerializer_495081042 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_495081042();
	...
	public BSerializer_495081042() {
		super(495081042);
	}
	
	public BSerializer_495081042(int typeId) {
		super(typeId);
	}
