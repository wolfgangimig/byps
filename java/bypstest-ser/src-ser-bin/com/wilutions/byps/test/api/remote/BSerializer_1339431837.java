...
public class BSerializer_1339431837 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1339431837();
	...
	public BSerializer_1339431837() {
		super(1339431837);
	}
	
	public BSerializer_1339431837(int typeId) {
		super(typeId);
	}
