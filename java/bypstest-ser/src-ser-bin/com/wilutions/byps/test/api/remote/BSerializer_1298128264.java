...
public class BSerializer_1298128264 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1298128264();
	...
	public BSerializer_1298128264() {
		super(1298128264);
	}
	
	public BSerializer_1298128264(int typeId) {
		super(typeId);
	}
