...
public class BSerializer_516213777 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_516213777();
	...
	public BSerializer_516213777() {
		super(516213777);
	}
	
	public BSerializer_516213777(int typeId) {
		super(typeId);
	}
