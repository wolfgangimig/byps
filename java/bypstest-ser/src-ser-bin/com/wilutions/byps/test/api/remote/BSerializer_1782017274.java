...
public class BSerializer_1782017274 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1782017274();
	...
	public BSerializer_1782017274() {
		super(1782017274);
	}
	
	public BSerializer_1782017274(int typeId) {
		super(typeId);
	}
