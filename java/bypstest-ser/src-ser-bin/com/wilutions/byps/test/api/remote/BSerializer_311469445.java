...
public class BSerializer_311469445 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_311469445();
	...
	public BSerializer_311469445() {
		super(311469445);
	}
	
	public BSerializer_311469445(int typeId) {
		super(typeId);
	}
