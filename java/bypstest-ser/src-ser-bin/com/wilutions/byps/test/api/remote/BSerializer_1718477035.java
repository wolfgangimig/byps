...
public class BSerializer_1718477035 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1718477035();
	...
	public BSerializer_1718477035() {
		super(1718477035);
	}
	
	public BSerializer_1718477035(int typeId) {
		super(typeId);
	}
