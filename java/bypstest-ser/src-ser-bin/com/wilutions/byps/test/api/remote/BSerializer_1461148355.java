...
public class BSerializer_1461148355 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1461148355();
	...
	public BSerializer_1461148355() {
		super(1461148355);
	}
	
	public BSerializer_1461148355(int typeId) {
		super(typeId);
	}
