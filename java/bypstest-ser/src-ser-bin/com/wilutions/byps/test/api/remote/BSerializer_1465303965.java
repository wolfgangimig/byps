...
public class BSerializer_1465303965 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1465303965();
	...
	public BSerializer_1465303965() {
		super(1465303965);
	}
	
	public BSerializer_1465303965(int typeId) {
		super(typeId);
	}
