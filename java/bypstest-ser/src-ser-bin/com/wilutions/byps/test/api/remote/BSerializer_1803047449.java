...
public class BSerializer_1803047449 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1803047449();
	...
	public BSerializer_1803047449() {
		super(1803047449);
	}
	
	public BSerializer_1803047449(int typeId) {
		super(typeId);
	}
