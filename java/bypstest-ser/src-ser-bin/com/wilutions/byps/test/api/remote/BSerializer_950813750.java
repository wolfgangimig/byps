...
public class BSerializer_950813750 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_950813750();
	...
	public BSerializer_950813750() {
		super(950813750);
	}
	
	public BSerializer_950813750(int typeId) {
		super(typeId);
	}
