...
public class BSerializer_502125363 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_502125363();
	...
	public BSerializer_502125363() {
		super(502125363);
	}
	
	public BSerializer_502125363(int typeId) {
		super(typeId);
	}
