...
public class BSerializer_1019539667 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1019539667();
	...
	public BSerializer_1019539667() {
		super(1019539667);
	}
	
	public BSerializer_1019539667(int typeId) {
		super(typeId);
	}
