...
public class BSerializer_789091462 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_789091462();
	...
	public BSerializer_789091462() {
		super(789091462);
	}
	
	public BSerializer_789091462(int typeId) {
		super(typeId);
	}
