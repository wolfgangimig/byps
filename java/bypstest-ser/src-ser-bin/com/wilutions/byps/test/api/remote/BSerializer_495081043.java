...
public class BSerializer_495081043 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_495081043();
	...
	public BSerializer_495081043() {
		super(495081043);
	}
	
	public BSerializer_495081043(int typeId) {
		super(typeId);
	}
