...
public class BSerializer_1199298026 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1199298026();
	...
	public BSerializer_1199298026() {
		super(1199298026);
	}
	
	public BSerializer_1199298026(int typeId) {
		super(typeId);
	}
