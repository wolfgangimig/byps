...
public class BSerializer_1870847402 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1870847402();
	...
	public BSerializer_1870847402() {
		super(1870847402);
	}
	
	public BSerializer_1870847402(int typeId) {
		super(typeId);
	}
