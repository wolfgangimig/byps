...
public class BSerializer_1460981451 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1460981451();
	...
	public BSerializer_1460981451() {
		super(1460981451);
	}
	
	public BSerializer_1460981451(int typeId) {
		super(typeId);
	}
