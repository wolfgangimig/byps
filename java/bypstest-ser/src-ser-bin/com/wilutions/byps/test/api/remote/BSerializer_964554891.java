...
public class BSerializer_964554891 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_964554891();
	...
	public BSerializer_964554891() {
		super(964554891);
	}
	
	public BSerializer_964554891(int typeId) {
		super(typeId);
	}
