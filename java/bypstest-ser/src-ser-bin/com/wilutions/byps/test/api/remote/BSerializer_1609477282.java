...
public class BSerializer_1609477282 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1609477282();
	...
	public BSerializer_1609477282() {
		super(1609477282);
	}
	
	public BSerializer_1609477282(int typeId) {
		super(typeId);
	}
