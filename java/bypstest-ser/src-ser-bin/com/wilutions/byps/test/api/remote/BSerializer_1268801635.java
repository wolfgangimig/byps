...
public class BSerializer_1268801635 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1268801635();
	...
	public BSerializer_1268801635() {
		super(1268801635);
	}
	
	public BSerializer_1268801635(int typeId) {
		super(typeId);
	}
