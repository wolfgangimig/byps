...
public class BSerializer_946246435 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_946246435();
	...
	public BSerializer_946246435() {
		super(946246435);
	}
	
	public BSerializer_946246435(int typeId) {
		super(typeId);
	}
