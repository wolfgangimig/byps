...
public class BSerializer_1390595154 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1390595154();
	...
	public BSerializer_1390595154() {
		super(1390595154);
	}
	
	public BSerializer_1390595154(int typeId) {
		super(typeId);
	}
