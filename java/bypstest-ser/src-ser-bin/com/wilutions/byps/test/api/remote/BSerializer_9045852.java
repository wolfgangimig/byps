...
public class BSerializer_9045852 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_9045852();
	...
	public BSerializer_9045852() {
		super(9045852);
	}
	
	public BSerializer_9045852(int typeId) {
		super(typeId);
	}
