...
public class BSerializer_333929444 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_333929444();
	...
	public BSerializer_333929444() {
		super(333929444);
	}
	
	public BSerializer_333929444(int typeId) {
		super(typeId);
	}
