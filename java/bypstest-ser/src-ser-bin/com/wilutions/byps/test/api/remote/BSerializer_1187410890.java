...
public class BSerializer_1187410890 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1187410890();
	...
	public BSerializer_1187410890() {
		super(1187410890);
	}
	
	public BSerializer_1187410890(int typeId) {
		super(typeId);
	}
