...
public class BSerializer_1803047450 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1803047450();
	...
	public BSerializer_1803047450() {
		super(1803047450);
	}
	
	public BSerializer_1803047450(int typeId) {
		super(typeId);
	}
