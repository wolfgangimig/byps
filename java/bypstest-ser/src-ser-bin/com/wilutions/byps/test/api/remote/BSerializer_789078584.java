...
public class BSerializer_789078584 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_789078584();
	...
	public BSerializer_789078584() {
		super(789078584);
	}
	
	public BSerializer_789078584(int typeId) {
		super(typeId);
	}
