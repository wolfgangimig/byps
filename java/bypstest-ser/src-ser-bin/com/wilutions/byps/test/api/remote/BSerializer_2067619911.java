...
public class BSerializer_2067619911 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_2067619911();
	...
	public BSerializer_2067619911() {
		super(2067619911);
	}
	
	public BSerializer_2067619911(int typeId) {
		super(typeId);
	}
