...
public class BSerializer_1166332006 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1166332006();
	...
	public BSerializer_1166332006() {
		super(1166332006);
	}
	
	public BSerializer_1166332006(int typeId) {
		super(typeId);
	}
