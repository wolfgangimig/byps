...
public class BSerializer_467089588 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_467089588();
	...
	public BSerializer_467089588() {
		super(467089588);
	}
	
	public BSerializer_467089588(int typeId) {
		super(typeId);
	}
