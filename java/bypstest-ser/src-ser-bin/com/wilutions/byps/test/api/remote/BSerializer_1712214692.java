...
public class BSerializer_1712214692 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1712214692();
	...
	public BSerializer_1712214692() {
		super(1712214692);
	}
	
	public BSerializer_1712214692(int typeId) {
		super(typeId);
	}
