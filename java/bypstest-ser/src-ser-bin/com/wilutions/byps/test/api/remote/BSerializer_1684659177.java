...
public class BSerializer_1684659177 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1684659177();
	...
	public BSerializer_1684659177() {
		super(1684659177);
	}
	
	public BSerializer_1684659177(int typeId) {
		super(typeId);
	}
