...
public class BSerializer_1554048913 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1554048913();
	...
	public BSerializer_1554048913() {
		super(1554048913);
	}
	
	public BSerializer_1554048913(int typeId) {
		super(typeId);
	}
