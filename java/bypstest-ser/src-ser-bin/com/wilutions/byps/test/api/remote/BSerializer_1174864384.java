...
public class BSerializer_1174864384 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1174864384();
	...
	public BSerializer_1174864384() {
		super(1174864384);
	}
	
	public BSerializer_1174864384(int typeId) {
		super(typeId);
	}
