...
public class BSerializer_1305065684 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1305065684();
	...
	public BSerializer_1305065684() {
		super(1305065684);
	}
	
	public BSerializer_1305065684(int typeId) {
		super(typeId);
	}
