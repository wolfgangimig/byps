...
public class BSerializer_2079507047 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_2079507047();
	...
	public BSerializer_2079507047() {
		super(2079507047);
	}
	
	public BSerializer_2079507047(int typeId) {
		super(typeId);
	}
