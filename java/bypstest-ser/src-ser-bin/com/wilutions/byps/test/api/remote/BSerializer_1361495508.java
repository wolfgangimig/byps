...
public class BSerializer_1361495508 extends BSerializer {
	
	public final static BSerializer instance = new BSerializer_1361495508();
	...
	public BSerializer_1361495508() {
		super(1361495508);
	}
	
	public BSerializer_1361495508(int typeId) {
		super(typeId);
	}
