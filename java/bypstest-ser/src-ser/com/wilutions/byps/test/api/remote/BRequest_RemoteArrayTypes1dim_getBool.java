...
public final class BRequest_RemoteArrayTypes1dim_getBool implements BMethodRequest, Serializable {
	...
	public void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) throws Throwable {
		try {
			...
			BAsyncResultSendMethod<boolean[]> __byps__outerResult = new BAsyncResultSendMethod<boolean[]>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_2058423690());			
