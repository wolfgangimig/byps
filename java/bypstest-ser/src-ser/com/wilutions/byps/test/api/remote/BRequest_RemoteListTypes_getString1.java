...
public final class BRequest_RemoteListTypes_getString1 implements BMethodRequest, Serializable {
	...
	public void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) throws Throwable {
		try {
			...
			BAsyncResultSendMethod<java.util.List<java.lang.String>> __byps__outerResult = new BAsyncResultSendMethod<java.util.List<java.lang.String>>(__byps__asyncResult, new com.wilutions.byps.test.api.BResult_2123584667());			
