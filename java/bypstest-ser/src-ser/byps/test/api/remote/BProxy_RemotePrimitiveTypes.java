...
/**
 * This class provides a proxy implementation of the interface RemotePrimitiveTypes.
 */
@SuppressWarnings("all")
public class BProxy_RemotePrimitiveTypes extends BSkeleton_RemotePrimitiveTypes implements RemotePrimitiveTypesAsync {
	
	public static final long serialVersionUID = 456456L;
	
	protected final byps.test.api.remote.RemotePrimitiveTypesAsync forwardTo;
	
	public BProxy_RemotePrimitiveTypes(RemotePrimitiveTypesAsync forwardTo) {
		this.forwardTo = forwardTo;
	}
	
	public BProxy_RemotePrimitiveTypes(BTransport transport) {
		this(new BForward_RemotePrimitiveTypes(transport));
	}
