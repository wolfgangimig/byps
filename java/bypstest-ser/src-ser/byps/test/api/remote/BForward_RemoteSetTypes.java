...
public class BForward_RemoteSetTypes extends BStub implements RemoteSetTypesAsync {
	
	protected BForward_RemoteSetTypes() {
	}
	
	public BForward_RemoteSetTypes(final BTransport transport) {
		super(transport);		
	}
