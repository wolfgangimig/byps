...
public class BStub_RemoteSetTypes extends BStub implements RemoteSetTypesAsync, java.io.Serializable {
	...
	protected final BForward_RemoteSetTypes forwardTo;	
	
	@SuppressWarnings("unused") private BStub_RemoteSetTypes() {
		this.forwardTo = new BForward_RemoteSetTypes();
	}
	
	public BStub_RemoteSetTypes(final BTransport transport) {
		super(transport);
		this.forwardTo = new BForward_RemoteSetTypes(transport);
