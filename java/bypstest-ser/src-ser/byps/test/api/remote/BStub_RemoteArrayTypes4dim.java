...
public class BStub_RemoteArrayTypes4dim extends BStub implements RemoteArrayTypes4dimAsync, java.io.Serializable {
	...
	protected final BForward_RemoteArrayTypes4dim forwardTo;	
	
	@SuppressWarnings("unused") private BStub_RemoteArrayTypes4dim() {
		this.forwardTo = new BForward_RemoteArrayTypes4dim();
	}
	
	public BStub_RemoteArrayTypes4dim(final BTransport transport) {
		super(transport);
		this.forwardTo = new BForward_RemoteArrayTypes4dim(transport);
