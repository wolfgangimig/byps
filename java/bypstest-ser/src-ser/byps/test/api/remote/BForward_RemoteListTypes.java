...
public class BForward_RemoteListTypes extends BStub implements RemoteListTypesAsync {
	
	protected BForward_RemoteListTypes() {
	}
	
	public BForward_RemoteListTypes(final BTransport transport) {
		super(transport);		
	}
