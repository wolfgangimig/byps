...
public final class BRequest_RemoteArrayTypes4dim_getDate extends BMethodRequest implements Serializable {

	
	public static final long serialVersionUID = 1874256219L;
	...
	public String toString() {
		...
		s.append("[RemoteArrayTypes4dim.getDate(");
		s.append(")]");
		return s.toString();
	}
