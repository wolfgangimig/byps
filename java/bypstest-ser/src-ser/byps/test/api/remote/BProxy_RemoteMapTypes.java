...
/**
 * This class provides a proxy implementation of the interface RemoteMapTypes.
 */
@SuppressWarnings("all")
public class BProxy_RemoteMapTypes extends BSkeleton_RemoteMapTypes implements RemoteMapTypesAsync {
	
	public static final long serialVersionUID = 664304990L;
	
	protected final byps.test.api.remote.RemoteMapTypesAsync forwardTo;
	
	public BProxy_RemoteMapTypes(RemoteMapTypesAsync forwardTo) {
		this.forwardTo = forwardTo;
	}
	
	public BProxy_RemoteMapTypes(BTransport transport) {
		this(new BForward_RemoteMapTypes(transport));
	}
