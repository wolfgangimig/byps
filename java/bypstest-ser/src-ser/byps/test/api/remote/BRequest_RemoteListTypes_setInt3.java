...
public final class BRequest_RemoteListTypes_setInt3 extends BMethodRequest implements Serializable {
	...
	public final static long serialVersionUID = 136821226L;
	...
	public void execute(BRemote __byps__remote, BAsyncResult<Object> __byps__asyncResult) throws Throwable {
		try {
			...
			__byps__remoteT.setInt3(int3, __byps__outerResult);
		} catch (Throwable e) {
	...
	public String toString() {
		...
		s.append("[RemoteListTypes.setInt3(");
		s.append(BBuffer.paramToString(int3));
		s.append(")]");
		return s.toString();
	}
