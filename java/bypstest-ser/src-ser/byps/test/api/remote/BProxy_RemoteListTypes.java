...
/**
 * This class provides a proxy implementation of the interface RemoteListTypes.
 */
@SuppressWarnings("all")
public class BProxy_RemoteListTypes extends BSkeleton_RemoteListTypes implements RemoteListTypesAsync {
	
	public static final long serialVersionUID = 1233438138L;
	
	protected final byps.test.api.remote.RemoteListTypesAsync forwardTo;
	
	public BProxy_RemoteListTypes(RemoteListTypesAsync forwardTo) {
		this.forwardTo = forwardTo;
	}
	
	public BProxy_RemoteListTypes(BTransport transport) {
		this(new BForward_RemoteListTypes(transport));
	}
