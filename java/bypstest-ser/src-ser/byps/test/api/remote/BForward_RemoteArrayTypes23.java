...
public class BForward_RemoteArrayTypes23 extends BStub implements RemoteArrayTypes23Async {
	
	protected BForward_RemoteArrayTypes23() {
	}
	
	public BForward_RemoteArrayTypes23(final BTransport transport) {
		super(transport);		
	}
