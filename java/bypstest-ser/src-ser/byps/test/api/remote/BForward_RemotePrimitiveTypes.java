...
public class BForward_RemotePrimitiveTypes extends BStub implements RemotePrimitiveTypesAsync {
	
	protected BForward_RemotePrimitiveTypes() {
	}
	
	public BForward_RemotePrimitiveTypes(final BTransport transport) {
		super(transport);		
	}
