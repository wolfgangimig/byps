...
public class BSkeleton_RemoteListTypes extends BSkeleton implements RemoteListTypesAsync {
	...
	public final static long serialVersionUID = 1240892695L;
	...
	public void getPrimitiveTypes1(final BAsyncResult<java.util.List<byps.test.api.prim.PrimitiveTypes>> asyncResult) {
		try {
			java.util.List<byps.test.api.prim.PrimitiveTypes> ret = getPrimitiveTypes1();
			asyncResult.setAsyncResult(ret, null);
		} catch (Throwable e) {
			asyncResult.setAsyncResult(null, e);
		}
	...
	public void getDate1(final BAsyncResult<java.util.List<java.util.Date>> asyncResult) {
		try {
			java.util.List<java.util.Date> ret = getDate1();
			asyncResult.setAsyncResult(ret, null);
		} catch (Throwable e) {
			asyncResult.setAsyncResult(null, e);
		}
