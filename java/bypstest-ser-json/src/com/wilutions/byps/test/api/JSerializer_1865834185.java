...
public class JSerializer_1865834185 extends BSerializer {
	...
	public Object read(final Object obj1, final BInput bin1, final int version) throws BException {
		...
		for (int i0 = 0; i0 < n; i0++) {
			java.util.List<int[][][][]> obj = (java.util.List<int[][][][]>)bin.readObj(i0, false, com.wilutions.byps.test.api.JSerializer_1088217157.instance);
			arr.add(obj);
		}
		return arr;
	}
	...
	public void write(Object obj1, BOutput bout1, int version)  throws BException {
		...
		for (java.util.List<int[][][][]> obj : arr) {
			bout.writeObj(null, obj, false, com.wilutions.byps.test.api.JSerializer_1088217157.instance);
		}
		bbuf.endArray();
	}
