...
public class JSerializer_1942905966 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1942905966();
	
	
	public JSerializer_1942905966() {
		super(1942905966);
	}
	
	public JSerializer_1942905966(int typeId) {
		super(typeId);
	}
