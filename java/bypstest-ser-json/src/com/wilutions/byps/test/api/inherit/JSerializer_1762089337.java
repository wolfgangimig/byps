...
public class JSerializer_1762089337 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1762089337();
	
	public JSerializer_1762089337() {
		super(1762089337);
	}
	
	public JSerializer_1762089337(int typeId) {
		super(typeId);
	}
