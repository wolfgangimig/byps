...
public class JSerializer_1944613800 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1944613800();
	
	
	public JSerializer_1944613800() {
		super(1944613800);
	}
	
	public JSerializer_1944613800(int typeId) {
		super(typeId);
	}
