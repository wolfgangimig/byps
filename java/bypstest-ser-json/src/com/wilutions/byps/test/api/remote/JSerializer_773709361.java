...
public class JSerializer_773709361 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_773709361();
	
	
	public JSerializer_773709361() {
		super(773709361);
	}
	
	public JSerializer_773709361(int typeId) {
		super(typeId);
	}
