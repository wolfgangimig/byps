...
public class JSerializer_1708889390 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1708889390();
	
	
	public JSerializer_1708889390() {
		super(1708889390);
	}
	
	public JSerializer_1708889390(int typeId) {
		super(typeId);
	}
