...
public class JSerializer_431810267 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_431810267();
	
	
	public JSerializer_431810267() {
		super(431810267);
	}
	
	public JSerializer_431810267(int typeId) {
		super(typeId);
	}
