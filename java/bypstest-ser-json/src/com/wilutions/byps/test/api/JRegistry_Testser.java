...
public class JRegistry_Testser extends BRegistry { 
	...
	public BSerializer getApiSerializer(int typeId) {
		...
		if (typeId == 67092708) return com.wilutions.byps.test.api.remote.JSerializer_67092708.instance;
		...
		if (typeId == 1170165676) return com.wilutions.byps.test.api.remote.JSerializer_1170165676.instance;
		...
		if (typeId == 641509600) return com.wilutions.byps.test.api.remote.JSerializer_641509600.instance;
		...
		if (typeId == 11000) return com.wilutions.byps.test.api.remote.JSerializer_11000.instance;
		...
		if (typeId == 1888829108) return com.wilutions.byps.test.api.remote.JSerializer_1888829108.instance;
		...
		if (typeId == 11001) return com.wilutions.byps.test.api.remote.JSerializer_11001.instance;
		...
		if (typeId == 1959416539) return com.wilutions.byps.test.api.remote.JSerializer_1959416539.instance;
		// com.wilutions.byps.test.api.prim.PrimitiveTypes[][][][]
		...
		if (typeId == 2113544940) return com.wilutions.byps.test.api.remote.JSerializer_2113544940.instance;
		...
		if (typeId == 1039162031) return com.wilutions.byps.test.api.cons.JSerializer_1039162031.instance;
		...
		if (typeId == 533533486) return com.wilutions.byps.test.api.remote.JSerializer_533533486.instance;
		...
		if (typeId == 805985960) return com.wilutions.byps.test.api.remote.JSerializer_805985960.instance;
		...
		if (typeId == 1039162054) return com.wilutions.byps.test.api.cons.JSerializer_1039162054.instance;
		...
		if (typeId == 1025539738) return com.wilutions.byps.test.api.remote.JSerializer_1025539738.instance;
		// long[][][][]
		...
		if (typeId == 619221761) return com.wilutions.byps.test.api.cons.JSerializer_619221761.instance;
		...
		// com.wilutions.byps.test.api.cons.AllTypesZ
		if (typeId == 619221784) return com.wilutions.byps.test.api.cons.JSerializer_619221784.instance;
