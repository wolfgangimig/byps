...
public class JRegistry_Testser extends BRegistry { 
	...
	public BSerializer getApiSerializer(int typeId) {
		...
		if (typeId == 56089321) return com.wilutions.byps.test.api.JSerializer_56089321.instance;
		...
		if (typeId == 65775978) return com.wilutions.byps.test.api.auth.JSerializer_65775978.instance;
		...
		if (typeId == 724361898) return com.wilutions.byps.test.api.inherit.JSerializer_724361898.instance;
		// com.wilutions.byps.test.api.inherit.BRequest_BioLemonService_useParing
		if (typeId == 1762089337) return com.wilutions.byps.test.api.inherit.JSerializer_1762089337.instance;
		// com.wilutions.byps.test.api.inherit.BRequest_FruitService_squeeze
		if (typeId == 656804784) return com.wilutions.byps.test.api.inherit.JSerializer_656804784.instance;
		// com.wilutions.byps.test.api.inherit.BRequest_LemonService_pick
		if (typeId == 1860602130) return com.wilutions.byps.test.api.inherit.JSerializer_1860602130.instance;
		// com.wilutions.byps.test.api.inherit.BRequest_PlantService_grow
		if (typeId == 1534230652) return com.wilutions.byps.test.api.inherit.JSerializer_1534230652.instance;
		// com.wilutions.byps.test.api.inherit.BStub_BioFruitService
		if (typeId == 1881829396) return com.wilutions.byps.test.api.inherit.JSerializer_1881829396.instance;
		// com.wilutions.byps.test.api.inherit.BStub_BioLemonService
		if (typeId == 1992245333) return com.wilutions.byps.test.api.inherit.JSerializer_1992245333.instance;
		// com.wilutions.byps.test.api.inherit.BStub_FruitService
		if (typeId == 506940662) return com.wilutions.byps.test.api.inherit.JSerializer_506940662.instance;
		// com.wilutions.byps.test.api.inherit.BStub_LemonService
		if (typeId == 617356599) return com.wilutions.byps.test.api.inherit.JSerializer_617356599.instance;
		// com.wilutions.byps.test.api.inherit.BStub_PlantService
		if (typeId == 1117460801) return com.wilutions.byps.test.api.inherit.JSerializer_1117460801.instance;
		...
		if (typeId == 1845930195) return com.wilutions.byps.test.api.remote.JSerializer_1845930195.instance;
		...
		if (typeId == 388793292) return com.wilutions.byps.test.api.remote.JSerializer_388793292.instance;
		// com.wilutions.byps.test.api.remote.BRequest_RemoteWithAuthentication_expire
		if (typeId == 68943581) return com.wilutions.byps.test.api.remote.JSerializer_68943581.instance;
		// com.wilutions.byps.test.api.remote.BRequest_RemoteWithAuthentication_login
		if (typeId == 839695851) return com.wilutions.byps.test.api.remote.JSerializer_839695851.instance;
		// com.wilutions.byps.test.api.remote.BRequest_RemoteWithAuthentication_setReloginCount
		if (typeId == 20608797) return com.wilutions.byps.test.api.remote.JSerializer_20608797.instance;
		// com.wilutions.byps.test.api.remote.BRequest_RemoteWithAuthentication_setUseAuthentication
		if (typeId == 1785294043) return com.wilutions.byps.test.api.remote.JSerializer_1785294043.instance;
		...
		if (typeId == 1677934392) return com.wilutions.byps.test.api.remote.JSerializer_1677934392.instance;
