...
public class JSerializer_534004421 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_534004421();
	
	public JSerializer_534004421() {
		super(534004421);
	}
	
	public JSerializer_534004421(int typeId) {
		super(typeId);
	}
