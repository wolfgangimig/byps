...
public class JSerializer_2030857950 extends JSerializer_Array {
	
	public final static BSerializer instance = new JSerializer_2030857950();
	
	public JSerializer_2030857950() {
		super(2030857950);
	}
