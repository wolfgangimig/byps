...
public class JSerializer_871356108 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_871356108();
	
	public JSerializer_871356108() {
		super(871356108);
	}
	
	public JSerializer_871356108(int typeId) {
		super(typeId);
	}
	...
	public Object internalRead(final Object obj1, final BInputJson bin) throws BException {
		...
		obj.result = (byps.test.api.inl.Actor)bin.readObj("result", false, null);
