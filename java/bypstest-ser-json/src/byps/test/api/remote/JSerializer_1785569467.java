...
public class JSerializer_1785569467 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1785569467();
	
	public JSerializer_1785569467() {
		super(1785569467);
	}
	
	public JSerializer_1785569467(int typeId) {
		super(typeId);
	}
