...
public class JSerializer_2080406641 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_2080406641();
	
	public JSerializer_2080406641() {
		super(2080406641);
	}
	
	public JSerializer_2080406641(int typeId) {
		super(typeId);
	}
