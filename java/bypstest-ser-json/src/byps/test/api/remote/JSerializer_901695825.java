...
public class JSerializer_901695825 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_901695825();
	
	public JSerializer_901695825() {
		super(901695825);
	}
	
	public JSerializer_901695825(int typeId) {
		super(typeId);
	}
