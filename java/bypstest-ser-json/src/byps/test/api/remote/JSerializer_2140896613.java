...
public class JSerializer_2140896613 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_2140896613();
	
	public JSerializer_2140896613() {
		super(2140896613);
	}
	
	public JSerializer_2140896613(int typeId) {
		super(typeId);
	}
