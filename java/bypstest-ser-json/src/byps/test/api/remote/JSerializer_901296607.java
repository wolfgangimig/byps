...
public class JSerializer_901296607 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_901296607();
	
	public JSerializer_901296607() {
		super(901296607);
	}
	
	public JSerializer_901296607(int typeId) {
		super(typeId);
	}
