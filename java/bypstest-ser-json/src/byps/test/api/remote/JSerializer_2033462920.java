...
public class JSerializer_2033462920 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_2033462920();
	
	public JSerializer_2033462920() {
		super(2033462920);
	}
	
	public JSerializer_2033462920(int typeId) {
		super(typeId);
	}
