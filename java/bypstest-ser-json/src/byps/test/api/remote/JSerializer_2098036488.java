...
public class JSerializer_2098036488 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_2098036488();
	
	public JSerializer_2098036488() {
		super(2098036488);
	}
	
	public JSerializer_2098036488(int typeId) {
		super(typeId);
	}
