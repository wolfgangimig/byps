...
public class JSerializer_124722646 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_124722646();
	
	public JSerializer_124722646() {
		super(124722646);
	}
	
	public JSerializer_124722646(int typeId) {
		super(typeId);
	}
