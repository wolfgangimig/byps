...
public class JSerializer_1210742444 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1210742444();
	
	public JSerializer_1210742444() {
		super(1210742444);
	}
	
	public JSerializer_1210742444(int typeId) {
		super(typeId);
	}
