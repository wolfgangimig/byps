...
public class JSerializer_1874004621 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1874004621();
	
	public JSerializer_1874004621() {
		super(1874004621);
	}
	
	public JSerializer_1874004621(int typeId) {
		super(typeId);
	}
