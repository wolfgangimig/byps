...
public class JSerializer_124323429 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_124323429();
	
	public JSerializer_124323429() {
		super(124323429);
	}
	
	public JSerializer_124323429(int typeId) {
		super(typeId);
	}
