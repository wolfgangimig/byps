...
public class JSerializer_1772393172 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1772393172();
	
	public JSerializer_1772393172() {
		super(1772393172);
	}
	
	public JSerializer_1772393172(int typeId) {
		super(typeId);
	}
