...
public class JSerializer_608885621 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_608885621();
	
	public JSerializer_608885621() {
		super(608885621);
	}
	
	public JSerializer_608885621(int typeId) {
		super(typeId);
	}
