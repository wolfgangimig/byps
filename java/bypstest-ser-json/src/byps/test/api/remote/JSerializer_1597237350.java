...
public class JSerializer_1597237350 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_1597237350();
	
	public JSerializer_1597237350() {
		super(1597237350);
	}
	
	public JSerializer_1597237350(int typeId) {
		super(typeId);
	}
