...
public class JSerializer_608486404 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_608486404();
	
	public JSerializer_608486404() {
		super(608486404);
	}
	
	public JSerializer_608486404(int typeId) {
		super(typeId);
	}
