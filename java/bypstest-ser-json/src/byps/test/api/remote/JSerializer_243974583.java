...
public class JSerializer_243974583 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_243974583();
	
	public JSerializer_243974583() {
		super(243974583);
	}
	
	public JSerializer_243974583(int typeId) {
		super(typeId);
	}
