...
public class JSerializer_2033139391 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_2033139391();
	
	public JSerializer_2033139391() {
		super(2033139391);
	}
	
	public JSerializer_2033139391(int typeId) {
		super(typeId);
	}
