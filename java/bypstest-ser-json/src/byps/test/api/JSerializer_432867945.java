...
public class JSerializer_432867945 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_432867945();
	
	public JSerializer_432867945() {
		super(432867945);
	}
	
	public JSerializer_432867945(int typeId) {
		super(typeId);
	}
