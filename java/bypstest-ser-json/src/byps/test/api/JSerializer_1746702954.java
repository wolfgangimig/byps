...
public class JSerializer_1746702954 extends BSerializer {
	...
	public Object read(final Object obj1, final BInput bin1, final long version) throws BException {
		...
		for (int i0 = 0; i0 < n; i0++) {
			java.util.List<java.lang.Integer> obj = (java.util.List<java.lang.Integer>)bin.readObj(i0, false, byps.test.api.JSerializer_181681714.instance);
			arr.add(obj);
		}
		return arr;
	}
	...
	public void write(Object obj1, BOutput bout1, final long version)  throws BException {
		...
		for (java.util.List<java.lang.Integer> obj : arr) {
			...
			bout.writeObj(null, obj, false, byps.test.api.JSerializer_181681714.instance);
		}
		bbuf.endArray();
	}
