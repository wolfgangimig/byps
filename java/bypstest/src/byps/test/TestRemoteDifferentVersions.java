...
public class TestRemoteDifferentVersions {
	...
	private void internaltestClientCallsServer(int clientVersion, int serverVersion) throws RemoteException {
		...
		BClient_Testser client2 = TestUtilsHttp.createClient(TestUtils.protocol, BWire.FLAG_DEFAULT, BMessageHeader.BYPS_VERSION_CURRENT, clientVersion, 1);
	...
	private void internaltestClientCallsAnotherClient(int clientVersion, int clientVersion2) throws RemoteException {
		...
		BClient_Testser client1 = TestUtilsHttp.createClient(TestUtils.protocol, BWire.FLAG_DEFAULT, BMessageHeader.BYPS_VERSION_CURRENT, clientVersion, 1);
		...
		BClient_Testser client2 = TestUtilsHttp.createClient(TestUtils.protocol, BWire.FLAG_DEFAULT, BMessageHeader.BYPS_VERSION_CURRENT, clientVersion2, 1);
