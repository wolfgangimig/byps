...
import com.wilutions.byps.test.api.inherit.Class1;
import com.wilutions.byps.test.api.inherit.Class1Collections;
import com.wilutions.byps.test.api.inherit.Class2;
import com.wilutions.byps.test.api.inherit.Class3;
...
public class TestSerializerClassHierarchy {
	...
	private Log log = LogFactory.getLog(TestSerializerClassHierarchy.class);
